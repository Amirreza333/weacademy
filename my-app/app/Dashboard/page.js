        ...
        <main className="flex-1 p-4 md:p-6 space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { title: 'سفارشات', value: '۵۶۷ مورد', change: '-۲.۱%', color: 'from-purple-500 to-pink-600' },
            ...
            <div className="bg-white/10 backdrop-blur-2xl rounded-2xl p-5 border border-white/10">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { text: 'سفارش #1234 ارسال شد', time: '۱۵ دقیقه پیش' },
                  { text: 'پرداخت ۵۰۰,۰۰۰ تومان', time: '۱ ساعت پیش' },
                  { text: 'محصول جدید اضافه شد', time: '۳ ساعت پیش' },
                ].map((act, i) => (
