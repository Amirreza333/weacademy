...
export default function VerifyPage() {
  ...
  const handleVerify = () => {
    ...
    setTimeout(() => {
      ...
      // ذخیره نقش کاربر (اگه هنوز ذخیره نشده)
      ...
      if (existingUser) {
        ...
        localStorage.setItem("user_role", role); // ذخیره نقش برای ثبت‌نام
    ...
    <>
      <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          {/* باکس‌های OTP — اعداد فارسی + پر شدن از چپ به راست */}
          <div className="mb-12">
              ...
              {otp.map((digit, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    maxLength="1"
                    value={digit}
                    onChange={(e) => handleChange(index, e.target.value)} // درست شد!
