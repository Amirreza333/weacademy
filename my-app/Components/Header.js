...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: "خدمات", href: "/services" }, // دسکتاپ: لینک ساده، بدون دراپ‌داون
      ...
      <header className="relative w-full max-w-7xl bg-[#0e121c]/90 backdrop-blur-3xl rounded-2xl overflow-hidden py-3 sm:py-4 border border-[#dbb91e]/50 shadow-2xl">
        ...
        <div className="relative container mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between">
            ...
            {/* منوی دسکتاپ — بدون دراپ‌داون خدمات */}
          ...
          {/* منوی موبایل — تمیز، هاور دار، بدون فلش */}
          {isMenuOpen && (
            <nav
              ref={menuRef}
