...
export default function About() {
  return (
    <section className="relative min-h-screen py-32 px-4 overflow-hidden" id="about">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="bg-white/5 backdrop-blur-3xl rounded-3xl p-8 md:p-16 border border-[#E8C56A]/40 shadow-2xl shadow-[#E8C56A]/20">
            ...
            {/* دکمه‌ها — کاملاً بهینه برای موبایل */}
            <div className="mt-16 flex flex-col sm:flex-row gap-5 sm:gap-8 justify-center items-center px-4">
              <Link
                href="/courses"
                className="group relative 
                           ...
                           sm:px-12 sm:py-6 
                           lg:px-14 lg:py-7
                           bg-gradient-to-r from-[#E8C56A] to-[#D4AF37] 
                           ...
                           hover:shadow-2xl hover:shadow-[#E8C56A]/60 
              ...
              <Link
                ...
                className="group 
                           ...
                           sm:px-12 sm:py-6 
                           lg:px-14 lg:py-7
                           border-2 border-[#E8C56A] 
                           text-[#E8C56A] font-bold 
                           rounded-full 
                           text-lg 
                           xs:text-xl 
                           sm:text-2xl 
                           transition-all duration-500 
                           hover:bg-[#E8C56A] hover:text-black 
                           hover:shadow-2xl hover:shadow-[#E8C56A]/50 
